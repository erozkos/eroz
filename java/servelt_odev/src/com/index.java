...
/* Ogrenci sýnýfý */
		Ogrenci ogr = new Ogrenci(11060649, "Ersin", "ÖZKÖSE", 1989, 21, 05, "Bil-Muh", "Samsun");
...
/* Memur Sýnýfý  */
		Memur mmr = new Memur(123123123, "Salih", "ÇAKIR", 1987, 271712123, "Ogrenci isleri");
...
/* Ogretmen sýnýfý */
		Ogretmen ort = new Ogretmen(321321321, "Sadi", "CENGÝZ", 1967, 112112123, "Matematik");
...
/* Ogretim uyesi sýnýfý  */
		OgretimUyesi ogr_uye = new OgretimUyesi(900123123, "MÜNÝR", "KOÇ", 1977, 929292, "Makina", "Yrd.Doç.Dr");
