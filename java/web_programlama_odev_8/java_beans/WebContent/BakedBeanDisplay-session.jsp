...
<div style = "margin-left: 0.5in;">
	...
	<h3 style = "color: black;">İsim: <jsp:getProperty name="sessionBean" property="name" /></h3>
	<h3 style = "color:	black;">Soyisim: <jsp:getProperty name="sessionBean" property="surname" /></h3><hr>
